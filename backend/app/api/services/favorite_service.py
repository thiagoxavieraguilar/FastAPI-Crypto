from app.core.repositories.favorite_repositorie import (
    FavoriteRepository,
...
class FavoriteService(Service):
    ...
    def create_favorite(self, symbol: str, user_id: int) -> FavoritesCrypto:
        favorite = self.repository.create_favorite_repository(
    ...
    def get_all_favorites(self, user_id: int) -> dict:
        ...
        favorite_list = [
            {"id": favorite.id, "symbol": favorite.symbol} for favorite in favorites
        ]
